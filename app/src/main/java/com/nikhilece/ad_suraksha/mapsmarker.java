...
public class mapsmarker extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(mapsmarker.this);
        Task<LocationSettingsResponse> task = settingsClient.checkLocationSettings(builder.build());

        task.addOnSuccessListener(mapsmarker.this, new OnSuccessListener<LocationSettingsResponse>() {
            @Override
        ...
        task.addOnFailureListener(mapsmarker.this, new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                if (e instanceof ResolvableApiException) {
                    ResolvableApiException resolvable = (ResolvableApiException) e;
                    try {
                        resolvable.startResolutionForResult(mapsmarker.this, 51);
