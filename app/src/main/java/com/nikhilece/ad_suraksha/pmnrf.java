...
public class pmnrf extends AppCompatActivity {
    ...
    WebView webView;
    private String webUrl = "https://pmnrf.gov.in/en/online-donation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(final String s, final String s1, final String s2, final String s3, long l) {
                ...
                Dexter.withActivity(pmnrf.this)
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionGranted(PermissionGrantedResponse response) {
                                ...
                                Toast.makeText(pmnrf.this, "Downloading File..", Toast.LENGTH_SHORT).show();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.toolbar_m,menu);
    ...
    private void upi() {
        startActivity ( new Intent(pmnrf.this, payment.class));
        Animatoo.animateSlideLeft(pmnrf.this);
    }
