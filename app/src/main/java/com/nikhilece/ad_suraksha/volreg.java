...
public class volreg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = database.getReference("volunteersRegister");
        ref.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(volreg.this, "unable to process try again", Toast.LENGTH_SHORT).show();
            }
        });
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(volreg.this, "Uploaded successfully", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed(){
        super.onBackPressed();
        startActivity ( new Intent(volreg.this, home.class));
        Animatoo.animateSlideRight(volreg.this);
    }
}
