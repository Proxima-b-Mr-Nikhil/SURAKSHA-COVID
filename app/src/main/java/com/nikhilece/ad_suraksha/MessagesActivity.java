...
public class MessagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userid = "AOWp6tSkP4QW5Pk9bUz5gNnyUAp1";
            ...
            reference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                        ...
                        if (chat.getReceiver().equals(nik) && chat.getSender().equals(userid) ||
                                chat.getReceiver().equals(userid) && chat.getSender().equals(nik)){
                            mchat.add(chat);
                        }
    ...
    public void onBackPressed(){
        super.onBackPressed();
        startActivity ( new Intent(MessagesActivity.this, home.class));
        Animatoo.animateSlideRight(MessagesActivity.this);
    }
}
