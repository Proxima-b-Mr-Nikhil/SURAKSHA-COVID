...
public class payment extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roll=(EditText)findViewById(R.id.r);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                String upivirtualid="pmcares@sbi";
                ...
                else if (TextUtils.isEmpty(roll.getText().toString().trim())){
                    Toast.makeText(payment.this," invalid", Toast.LENGTH_SHORT).show();
                }
                else{
                    payUsingUpi(name.getText().toString(),upivirtualid,
                            roll.getText().toString(), amount.getText().toString());
                }
            }
        });
    }
    ...
    void payUsingUpi(String name, String upiId, String roll, String amount) {
        Log.e("main ", "name "+name +"--up--"+upiId+"--"+ roll+"--"+amount);
        Uri uri = Uri.parse("upi://pay").buildUpon()
                .appendQueryParameter("pa", upiId)
                .appendQueryParameter("pn", name)
                // .appendQueryParameter("mc", roll)
                //.appendQueryParameter("tid", "02125412")
                //.appendQueryParameter("tr", "25584584")
                .appendQueryParameter("tn", roll)
    ...
    public void onBackPressed(){
        super.onBackPressed();
        startActivity ( new Intent(payment.this, pmnrf.class));
        Animatoo.animateSlideRight(payment.this);
    }
}
